...
<template>
    <Link
        ...
        class="group relative flex flex-col items-center rounded-2xl border bg-white p-5 text-center shadow-card transition duration-300 hover:shadow-card-lg"
        :class="pro.is_featured ? 'border-amber-200 ring-1 ring-amber-100' : 'border-gray-100'"
    >
        <span v-if="pro.is_featured" class="absolute left-3 top-3 inline-flex items-center gap-1 rounded-md bg-amber-400 px-2 py-0.5 text-[10px] font-bold text-amber-900 shadow-sm">
        ...
        <span class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-brand-100 text-2xl font-semibold text-brand-700 ring-4 ring-brand-50 transition duration-300 group-hover:ring-brand-100">
